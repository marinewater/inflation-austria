 ...
 * @param {Event} e
 */
export function euro_past_listener( e: Event ) {

    const euro = euro_from_getter();
 ...
 * @param {Event} e
 */
export function schilling_past_listener( e: Event ) {

    const schilling = schilling_from_getter();
